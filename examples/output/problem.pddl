...
(define (problem quest-problem) ; problem name
  ...
  (:objects ; declare objects
    ...
    loc_2_branch2 - location ; location
    loc_2_branch3 - location ; location
    loc_3_branch1 - location ; location
    loc_3_branch2 - location ; location
    loc_3_branch3 - location ; location
    loc_4_branch1 - location ; location
    loc_4_branch2 - location ; location
    loc_4_branch3 - location ; location
  ...
  (:init ; initial state
    ...
    (= (branch-limit loc_2_branch2) 4) ; branch limit
    (= (actions-used loc_2_branch2) 0) ; actions used
    (= (branch-limit loc_2_branch3) 4) ; branch limit
    (= (actions-used loc_2_branch3) 0) ; actions used
    (= (branch-limit loc_3_branch1) 4) ; branch limit
    (= (actions-used loc_3_branch1) 0) ; actions used
    (= (branch-limit loc_3_branch2) 4) ; branch limit
    (= (actions-used loc_3_branch2) 0) ; actions used
    (= (branch-limit loc_3_branch3) 4) ; branch limit
    (= (actions-used loc_3_branch3) 0) ; actions used
    (= (branch-limit loc_4_branch1) 4) ; branch limit
    (= (actions-used loc_4_branch1) 0) ; actions used
    (= (branch-limit loc_4_branch2) 4) ; branch limit
    (= (actions-used loc_4_branch2) 0) ; actions used
    (= (branch-limit loc_4_branch3) 4) ; branch limit
    (= (actions-used loc_4_branch3) 0) ; actions used
    ...
    (connected loc_2 loc_2_branch2) ; connection forward
    (connected loc_2_branch2 loc_2) ; connection backward
    (connected loc_2 loc_2_branch3) ; connection forward
    (connected loc_2_branch3 loc_2) ; connection backward
    ...
    (connected loc_3 loc_3_branch2) ; connection forward
    (connected loc_3_branch2 loc_3) ; connection backward
    (connected loc_3 loc_3_branch3) ; connection forward
    (connected loc_3_branch3 loc_3) ; connection backward
    ...
    (connected loc_4 loc_4_branch2) ; connection forward
    (connected loc_4_branch2 loc_4) ; connection backward
    (connected loc_4 loc_4_branch3) ; connection forward
    (connected loc_4_branch3 loc_4) ; connection backward
    ...
    (connected loc_6 crystal_caverns) ; connection forward
    (connected crystal_caverns loc_6) ; connection backward
